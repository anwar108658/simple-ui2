  ...
  return (
    <div className="container mx-auto flex flex-col gap-9">
        ...
        <div className="w-full min-h-[90vh] flex flex-col">
          <div className="w-full mx-auto flex justify-center rounded-2xl flex-1 bg-[100%] bg-no-repeat max-w-[1000px]" style={{backgroundImage:"linear-gradient(to bottom right, rgba(9, 117, 136, 0.6), rgba(2, 17, 17, 0.1)),url('https://png.pngtree.com/thumb_back/fh260/background/20211217/pngtree-green-technology-background-vector-material-image_922624.jpg')"}}>
